<h2><a href="https://practice.geeksforgeeks.org/problems/kth-element-in-matrix/1?page=4&sprint=a663236c31453b969852f9ea22507634&sortBy=submissions">Kth element in Matrix</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px"><span style="font-family:arial,helvetica,sans-serif">Given a&nbsp;N&nbsp;x N&nbsp;matrix, where every row and column is sorted in non-decreasing order. Find the kth smallest element in the matrix.</span></span></p>
